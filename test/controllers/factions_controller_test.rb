...
class FactionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create faction" do
    assert_difference('Faction.count') do
      post factions_url, params: { faction: { description: @faction.description, name: @faction.name } }
    end
  ...
  test "should update faction" do
    patch faction_url(@faction), params: { faction: { description: @faction.description, name: @faction.name } }
