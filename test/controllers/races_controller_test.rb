...
class RacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create race" do
    assert_difference('Race.count') do
      post races_url, params: { race: { description: @race.description, name: @race.name, sentience_id: @race.sentience_id } }
    end
  ...
  test "should update race" do
    patch race_url(@race), params: { race: { description: @race.description, name: @race.name, sentience_id: @race.sentience_id } }
